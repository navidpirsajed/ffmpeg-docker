...
RUN    git clone --depth 1 https://github.com/navidpirsajed/fdk-aac ~/ffmpeg-libraries/fdk-aac \
  &&   git clone --depth 1 https://github.com/navidpirsajed/kvazaar ~/ffmpeg-libraries/kvazaar \
  &&   git clone --depth 1 https://chromium.googlesource.com/webm/libvpx ~/ffmpeg-libraries/libvpx \
  &&   git clone -b release-3.0.4 https://github.com/navidpirsajed/zimg ~/ffmpeg-libraries/zimg \
  &&   git clone --depth 1 https://aomedia.googlesource.com/aom ~/ffmpeg-libraries/aom \
  &&   git clone --branch release/5.0 --depth 1 https://github.com/navidpirsajed/FFmpeg ~/FFmpeg 
